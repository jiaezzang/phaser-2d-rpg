...
export default class StoreScene extends Phaser.Scene {
    ...
    create() {
        ...
        const tileBodies = this.platformsLayer
            ...
            .map((tile) => {
                return this.add.rectangle(tile.x * 16 + this.center, tile.y * 16 + 20, 16, 16).setOrigin(0, 1);
            });
        ...
        this.portal = new Portal(this, x + 550, y - 70, 'portal').setScale(0.7).setSize(120, 120);
        this.player = new Player(this, x + 100, y, 'player_' + this.playerType, 'stand1');
        this.pet = new Pet(this, x + 100, y - 100, 'blackPet', 'stand1', this.player);
        this.pet.rest = true;
    ...
    update() {
        ...
        // keyboard 누르지 않을 때
        if (!left.isDown && !right.isDown && !up.isDown && !down.isDown && !space.isDown) {
            this.pet.setVelocityX(0);
