export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      "player_angel",
      "player/angel/angel.png",
      "player/angel/angel.json"
    );
    this.load.atlas(
      "player_marona",
      "player/marona/marona.png",
      "player/marona/marona.json"
    );
    this.load.atlas(
      "player_witch",
      "player/witch/witch.png",
      "player/witch/witch.json"
    );
    ...
    this.load.atlas(
      "fireScratch",
      "tools/fireScratch/fireScratch.png",
      "tools/fireScratch/fireScratch.json"
    );
    this.load.atlas(
      "effect",
    ...
    this.load.atlas(
      "scratch",
      "tools/scratch/scratch.png",
      "tools/scratch/scratch.json"
    );
    this.load.atlas(
      "fireBeam",
      "tools/fireBeam/fireBeam.png",
      "tools/fireBeam/fireBeam.json"
    );
    this.load.atlas(
      "fireLight",
      "tools/fireLight/fireLight.png",
      "tools/fireLight/fireLight.json"
    );
